...
public class DSA_224_Merge_Two_Balanced_BST {
    static class Node {
    ...
    // Constructor
    DSA_224_Merge_Two_Balanced_BST() {
        root = null;
    }
    ...
    public static void main(String[] args) {
        DSA_224_Merge_Two_Balanced_BST tree1 = new DSA_224_Merge_Two_Balanced_BST();
        ...
        */
        ...
        DSA_224_Merge_Two_Balanced_BST tree2 = new DSA_224_Merge_Two_Balanced_BST();
        tree2.root = new Node(80);
        tree2.root.left = new Node(40);
        tree2.root.right = new Node(120);


        DSA_224_Merge_Two_Balanced_BST tree = new DSA_224_Merge_Two_Balanced_BST();
