...
public class DSA_341_Merge_k_Sorted_Arrays {
   static class MinHeapNode
    ...
    public DSA_341_Merge_k_Sorted_Arrays(MinHeapNode a[], int size)
    {
        heap_size = size;
        harr = a;
        int i = (heap_size - 1)/2;
    ...
    static void mergeKSortedArrays(int[][] arr, int k)
    {
        ...
        DSA_341_Merge_k_Sorted_Arrays mh = new DSA_341_Merge_k_Sorted_Arrays(hArr, k);
